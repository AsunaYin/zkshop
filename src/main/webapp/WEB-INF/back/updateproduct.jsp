                ...
                <tr>
                    ...
                    <td><br>
                        <div id="imgDiv"
                            ...
                            <img src="${pageContext.request.contextPath}/resources/image_big/${prod.image}" width="100px" height="100px">
                        </div>
                        <br>
                        <br>
                        <br>
                        ...
                        <input type="hidden" id="pimage" name="image" value="${prod.image}"> <span id="imgName">
                        </span>
                        <br>
                    </td>
                </tr>
